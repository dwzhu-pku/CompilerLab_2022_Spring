...
_lr_signature = 'DIVIDE LPAREN MINUS NAME NUMBER PLUS RPAREN TIMESexpression : expression PLUS termexpression : expression MINUS termexpression : termterm : term TIMES factorterm : term DIVIDE factorterm : factorfactor : NUMBERfactor : LPAREN expression RPAREN'
...
_lr_productions = [
  ...
  ('factor -> NUMBER','factor',1,'p_factor_num','parser.py',36),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser.py',40),
]
